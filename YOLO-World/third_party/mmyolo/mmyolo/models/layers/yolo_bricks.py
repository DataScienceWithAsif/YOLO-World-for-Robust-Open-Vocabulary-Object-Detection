...
class CSPLayerWithSoftNMS(nn.Module):
    """
    CSP Layer with Soft-NMS support
    """

    def __init__(self, use_soft_nms=True):
        super().__init__()
    ...
    def forward(self, boxes, scores):
        if self.use_soft_nms:
            ...
            keep = torch.arange(boxes.size(0))
